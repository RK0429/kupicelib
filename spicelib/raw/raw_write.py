...
class RawWrite(object):
    ...
    def __init__(
        self, plot_name=None, fastacces=True, numtype="auto", encoding="utf_16_le"
    ):
    ...
    def add_traces_from_raw(
        self, other: RawRead, trace_filter: Union[list, tuple, str], **kwargs
    ):
