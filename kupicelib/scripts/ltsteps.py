...
used in the simulation is not not very practical. The kupicelib ltsteps can be used to
reformat the text, so that the run parameter is added to the data as an additional
