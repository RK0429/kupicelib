...
from kupicelib.sim.tookit.fast_worst_case import FastWorstCaseAnalysis
...
nominal, min_value, max_comp_values, max_value, min_comp_values = wca.run_analysis(
    measure="fcut"
)  # Makes the Worst Case Analysis
