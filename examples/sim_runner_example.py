...
netlist.set_component_value(
    "R1", "4k"
)  # Alternative way of modifying the value of a resistor.
# Set component temperature, Tc 50ppm, remove power rating :
netlist.set_component_parameters("R1", temp=100, tc=0.000050, pwr=None)
netlist["R1"].set_params(
    temp=100, tc=0.000050, pwr=None
)  # Alternative way of setting parameters. Same as the above.
...
for opamp in (
    "AD712",
    "AD820_ALT_XU1",
):  # When updating an instance, the instance name gets appended to the subcircuit
