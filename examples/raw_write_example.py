def test_readme_snippet():
    ...
    from kupicelib import RawWrite, Trace
...
def test_trc2raw():  # Convert Teledyne-Lecroy trace files to raw files
    ...
    wave_size = 0
    with open(r"./testfiles/Current_Lock_Front_Right_8V.trc") as trace_file:
...
def test_axis_sync():  # Test axis sync
    ...
    from kupicelib import RawRead, RawWrite, Trace
...
def test_write_ac():
    from kupicelib import RawRead, RawWrite
