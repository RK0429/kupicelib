...
class ASC_Editor_Test(unittest.TestCase):
    ...
    def setUp(self):
        self.edt = kupicelib.editor.asc_editor.AscEditor(test_dir + "DC sweep.asc")
    ...
    def test_component_editing(self):
        ...
        self.equalFiles(
            temp_dir + "test_components_output.asc",
            golden_dir + "test_components_output.asc",
        )
        self.assertEqual(
        ...
        self.equalFiles(
            temp_dir + "test_components_output_2.asc",
            golden_dir + "test_components_output_2.asc",
        )
        ...
        self.equalFiles(
            temp_dir + "test_components_output_1.asc",
            golden_dir + "test_components_output_1.asc",
        )
    ...
    def test_parameter_edit(self):
        ...
        self.equalFiles(
            temp_dir + "test_parameter_output.asc",
            golden_dir + "test_parameter_output.asc",
        )
    ...
    def test_instructions(self):
        ...
        self.equalFiles(
            temp_dir + "test_instructions_output.asc",
            golden_dir + "test_instructions_output.asc",
        )
        self.edt.remove_instruction(".save I(R1)")
        self.edt.save_netlist(temp_dir + "test_instructions_output_1.asc")
        self.equalFiles(
            temp_dir + "test_instructions_output_1.asc",
        ...
        self.equalFiles(
            temp_dir + "test_instructions_output_2.asc",
            golden_dir + "test_instructions_output_2.asc",
        )
    ...
    def test_subcircuits_edit(self):
        ...
        * Check the subcomponent list * test various methods of reading and changing the
        ...
        self.assertEqual(
            ...
            {"Value": "22n", "SpiceLine": "Rser=1", "Rser": 1},
        ...
        self.equalFiles(
            temp_dir + "top_circuit_edit.asc", golden_dir + "top_circuit_edit.asc"
        )
        self.equalFiles(
            temp_dir + "subcircuit_edit.asc", golden_dir + "subcircuit_edit.asc"
        )
    ...
    def test_subcircuit_block_in_lib(self):
        ...
        self.assertAlmostEqual(
            my_edt["U1:R1"].value,
            320,
            msg="Subcircuit Value for U1:R1, float comparison",
        )
        my_edt["R2"].value = 20
        self.assertAlmostEqual(
            my_edt["R2"].value,
            20,
            msg="Subcircuit Value for R2, float comparison after edit",
        )
        ...
        self.assertAlmostEqual(
            my_edt["U1:R1"].value,
            320,
            msg="Subcircuit Value for U1:R1, modification should have been rejected",
        )
    ...
    def test_subcircuit_cell_in_lib(self):
        ...
        my_edt["R2"].value = 20
        self.assertAlmostEqual(
            my_edt["R2"].value, 20, msg="Value for R2, float comparison after edit"
        )
