...
class test_sweep_iterators(unittest.TestCase):
    ...
    def test_iterator_objects(self):
        ...
        self.assertListEqual(
            list(sweep(0.3, 1.1, 0.2)), [0.3, 0.5, 0.7, 0.9000000000000001, 1.1]
        )
        self.assertListEqual(
        ...
        self.assertListEqual(list(sweep(2, -2, -2)), [2, 0, -2])
        self.assertListEqual(
            list(sweep_n(0.3, 1.1, 5)), [0.3, 0.5, 0.7, 0.9000000000000001, 1.1]
        )
        self.assertListEqual(
        ...
        self.assertListEqual(
            list(sweep_log(0.1, 11e3, 10)), [0.1, 1.0, 10.0, 100.0, 1000.0, 10000.0]
        )
        self.assertListEqual(
